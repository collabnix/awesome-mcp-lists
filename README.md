...
| 5 | **knowledge-rag** | Local RAG for Claude Code via MCP — hybrid search (semantic + BM25 + RRF), cross-encoder reranking, markdown-aware chunking, 12 MCP tools, zero external servers. PyPI: `pip install knowledge-rag` (Author: Lyon, License: MIT). | TBD | [GitHub](https://github.com/lyonzin/knowledge-rag) |
