...
| 8 | **mcp-for-beginners** | This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration. | TBD | [GitHub](https://github.com/microsoft/mcp-for-beginners) |
| 9 | **fastapi_mcp** | Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth! | TBD | [GitHub](https://github.com/tadata-org/fastapi_mcp) |
| 10 | **klavis** | Klavis AI:  MCP integration platforms that let AI agents use tools reliably at any scale | TBD | [GitHub](https://github.com/Klavis-AI/klavis) |
| 11 | **osaurus** | Own your AI. The native macOS harness for AI agents -- any model, persistent memory, autonomous execution, cryptographic identity. Built in Swift. Fully offline. Open source. | TBD | [GitHub](https://github.com/osaurus-ai/osaurus) |
| 12 | **ENScan_GO** | 一款基于各大企业信息API的工具，解决在遇到的各种针对国内企业信息收集难题。一键收集控股公司ICP备案、APP、小程序、微信公众号等信息聚合导出。支持MCP接入 | TBD | [GitHub](https://github.com/wgpsec/ENScan_GO) |
| 13 | **Gmail-MCP-Server** | A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions. | TBD | [GitHub](https://github.com/GongRzhe/Gmail-MCP-Server) |
...
| 16 | **damn-vulnerable-MCP-server** | Damn Vulnerable MCP Server | TBD | [GitHub](https://github.com/harishsg993010/damn-vulnerable-MCP-server) |
